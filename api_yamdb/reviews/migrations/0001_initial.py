# Generated by Django 2.2.16 on 2022-04-28 18:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.ManyToManyField(related_name='genre', through='reviews.GenreAndTitleThrough', to='reviews.Genre', verbose_name='Жанр(ы)')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
        ...
        migrations.AddField(
            model_name='genreandtitlethrough',
            name='title',
